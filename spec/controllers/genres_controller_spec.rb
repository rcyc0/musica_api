  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Genre" do
        expect {
          post :create, params: {genre: valid_attributes}, session: valid_session
      ...
      it "renders a JSON response with the new genre" do
        ...
        expect(response.location).to eq(genre_url(Genre.last))
      end
    end
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the new genre" do
        ...
        post :create, params: {genre: invalid_attributes}, session: valid_session
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the genre" do
        ...
        put :update, params: {id: genre.to_param, genre: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the genre" do
        ...
        put :update, params: {id: genre.to_param, genre: invalid_attributes}, session: valid_session
        expect(response).to have_http_status(:unprocessable_entity)
        expect(response.content_type).to eq('application/json')
      end
    end
